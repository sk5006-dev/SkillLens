...
import { Eye, EyeOff, Lock, AlertTriangle, ArrowRight, Loader2, Check } from "lucide-react";
import { useRouter } from "next/navigation";

import { resetPasswordSchema, ResetPasswordInput } from "../../../validation/auth-schemas";
...
export default function ResetPasswordPage() {
  ...
  const { resetPassword, isLoading, isSuccess, error, clearError } = useAuthStore();
  ...
  // Success redirect hook to Login
  useEffect(() => {
    if (isSuccess) {
      ...
      <AuthCard isSuccess={isSuccess}>
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="text-[11px] text-text-secondary mt-1">Please define your new secure password credential.</p>
          </div>
          ...
          {error && (
            ...
            >
              ...
              <div>
                <p className="text-[10px] font-bold leading-none">Reset Failed</p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            {/* New Password Input (Floating Labels + Live requirements check) */}
            ...
            {/* Confirm Password Input (Floating Labels) */}
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-text-secondary/40">
                <Lock className="h-4 w-4" />
              </div>
